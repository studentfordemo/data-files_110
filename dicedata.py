...
#mean1= statistics.mean(dice_result)
...
#Plotting the chart, and lines for mean, 1 standard deviation and 2 standard 
# show_hist=False will make show histogram as false,if we remove it we can see bars in otput graph
fig = ff.create_distplot([dice_result], ["Result1"], show_hist=False)
...
print("% of data lies within 1 standard deviation",len(list_of_data_within_1_std_deviation)*100.0/len(dice_result))
